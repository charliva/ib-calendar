  ...
  return (
    ...
    >
      <section className="command-palette" aria-label="Command palette">
        <header>
          <Command size={17} />
          <span>Add or change anything</span>
          <button
            type="button"
        ...
        {mode === "upload" ? (
          <div className="upload-drop">
            ...
            <p>
              Timetable, ticket, syllabus, poster, image, text, or PDF. Nothing
              is applied without a diff.
            </p>
            <button
              type="button"
                ...
                <div>
                  ...
                  {homeworkCommandPreview.deadline && (
                    <>
                      <Move size={12} />
                      <i>
                        {formatDate(new Date(homeworkCommandPreview.deadline), {
                          weekday: "short",
                          hour: "2-digit",
                          minute: "2-digit",
                        })}
        ...
        <footer>
          <span>Type naturally. Changes apply immediately.</span>
          <span>You can undo calendar changes.</span>
        </footer>
      </section>
    </div>
  );
